...
void majweight(int out,int inputs)
	{
	int i,r1,r2,r3;
	...
	if(urand()>majprob)
		...
		while(r3==r1 || r3==r2 || (usedcount<out && used[r3]==1));
		...
		weight[r3]=randsgn()*sqrt((inputs+1.)/3.);
		}
	}
...
int main(int argc,char* argv[])
	...
	if(argc==4)
		...
		{
		printf("expected 3 arguments: majprob widthfile netfile\n");
		return 1;
		}
